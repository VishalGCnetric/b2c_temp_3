...
const AnimatedShoppingCart = () => {
  ...
  const [cartItems, setCartItems] = useState([
    { id: 1, name: 'Funky buds', price: 199.00, quantity: 1, image: 'https://gadgets21.zohocommerce.com/product-images/Product+Image-3.webp/5268485000000097545/400x400' },
    { id: 2, name: 'Skull Boi Headphone', price: 299.00, quantity: 1, image: 'https://gadgets21.zohocommerce.com/product-images/Product+Image-3.webp/5268485000000097545/400x400' },
  ]);
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className="w-full bg-gradient-to-r from-orange-500 to-pink-500 text-white py-3 rounded-lg font-semibold mt-4"
      ...
      <div className='mt-20'>
        <ProductSlider heading="You May Also Like" />
      </div>
    </div>
  );
};
