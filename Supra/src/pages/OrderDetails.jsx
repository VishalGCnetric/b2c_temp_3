    ...
    >
      ...
      <div className="mb-4">
        ...
        <div className="w-full bg-gray-200 h-2 rounded-full overflow-hidden mb-4">
          <motion.div
            className="bg-gradient-to-r from-orange-500 to-green-500 h-2"
      ...
      <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="bg-gradient-to-r from-orange-500 to-pink-500 text-white px-6 py-2 rounded mt-6 shadow-md hover:shadow-lg transition-all"
