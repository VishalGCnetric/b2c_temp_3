...
const orderData = {
  products: [
    { id: 1, name: "Dior Sunglasses", price: 299.99, quantity: 1, image: "https://gadgets21.zohocommerce.com/product-images/Product+Image-3.webp/5268485000000097545/400x400" },
    { id: 2, name: "Dior Bag", price: 499.99, quantity: 1, image: "https://gadgets21.zohocommerce.com/product-images/Product+Image-3.webp/5268485000000097545/400x400" }
  ],
  summary: {
    subtotal: 799.98,
    tax: 79.99,
        ...
        <AnimatePresence mode="wait">
            ...
            <motion.div key="address" variants={stepVariants} initial="hidden" animate="visible" exit="exit">
              ...
              <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 flex justify-between mt-6">
                  ...
                  <button type="button" className="bg-gradient-to-r from-orange-500 to-pink-500 text-white py-2 px-4 rounded-md" onClick={nextStep}>Continue</button>
                </div>
              </form>
            </motion.div>
          )}
          ...
          {currentStep === 2 && (
            <motion.div key="summary" variants={stepVariants} initial="hidden" animate="visible" exit="exit" className=" w-2/3">
              ...
              <div className="md:col-span-2 flex justify-between mt-6">
                <button type="button" className="bg-gradient-to-r from-gray-500 to-zinc-500 text-white py-2 px-4 rounded-md" onClick={prevStep}>Back</button>
                <button type="button" className="bg-gradient-to-r from-orange-500 to-green-500 text-white py-2 px-4 rounded-md" onClick={handlePayment}>Place Order</button>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
